...
LOCAL_CFLAGS += -DBOARD_RECOVERY_CHAR_WIDTH=$(BOARD_RECOVERY_CHAR_WIDTH) -DBOARD_RECOVERY_CHAR_HEIGHT=$(BOARD_RECOVERY_CHAR_HEIGHT) -DRECOVERY_BUILD_TIME="$(RECOVERY_BUILD_TIME)" -DRECOVERY_BUILDER="$(RECOVERY_BUILDER)" -DRECOVERY_PRODUCT_MODEL="$(PRODUCT_MODEL)"
